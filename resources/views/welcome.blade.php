...
<body class="antialiased bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white">
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-12">
                <h2 class="text-4xl font-bold mb-4">Latest from the Blog</h2>
                <p class="text-xl text-gray-400">Insights, updates, and stories from the Világműhely community</p>
            </div>
            ...
            <div class="text-center">
                <a href="{{ route('blog.index') }}" class="inline-flex items-center text-purple-400 hover:text-purple-300 transition text-lg">
            ...
            <div class="text-center py-12">
                <div class="text-6xl mb-4">📝</div>
                <p class="text-xl text-gray-400">Blog posts coming soon!</p>
                <p class="text-gray-500 mt-2">Stay tuned for insights and updates</p>
            </div>
            @endif
        </div>
    </section>
