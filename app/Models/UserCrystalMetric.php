...
class UserCrystalMetric extends Model
{
    ...
    protected $casts = [
        ...
        'purity_level' => 'float',
        'profile_completeness_modifier' => 'float',
        'initial_modifier_applied' => 'boolean',
    ...
    public function getCrystalData(): array
    {
        return [
            ...
            'modifiers' => [
                'profile_completeness' => round($this->profile_completeness_modifier, 2),
                'bonus_percentage' => round(($this->profile_completeness_modifier - 1.0) * 100, 0),
            ],
